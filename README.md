...
- **🤖 AI Insights (Gemini integration)**: Leverage Google's Gemini AI to analyze student performance and generate actionable insights.
...
- **📝 Evaluations & Notes**: Streamlined process for academic assessments and digital note-taking.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/ahda030222-cyber/myweb-campus.git
   cd myweb-campus
   ```
